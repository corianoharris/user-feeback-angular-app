...
@Component({
    ...
    <div class="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
      <h2 class="text-2xl font-bold mb-6 text-center">User Feedback Form</h2>
      ...
      <div *ngIf="submissions().length" class="mt-8">
        <h3 class="text-xl font-bold mb-4">Recent Submissions</h3>
        <div 
          *ngFor="let submission of submissions()" 
          class="bg-gray-100 p-4 rounded-lg mb-2 flex justify-between items-center"
        >
          <div>
